...
44. V4 plan fixed at36 fresh 120s episodes: action train12/test12 across all six role permutations, sealed passive stop/progress6, sealed matched legitimate/direct credential6. New lab scenarios record permit/block in separate `defender_actions.csv`; block creates T1021.004 Lateral Movement Attempt but no completed LM. No episodes captured yet; Docker rebuild+sustained foreground sudo required. See `docs/V4_ACTION_PLAN.md`.
