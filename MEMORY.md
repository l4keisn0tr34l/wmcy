...
56. V5 model protocol v1 was frozen pre-fit but first action invocation stopped before optimizer creation: inherited V4 CUDA smoke demanded exact0 future delta and observed4.470348e-8, consistent with prior V5 CUDA2.980232e-8. No model/output/validation/test access. Log SHA5e3198d... and original freeze/scaler archived as invalid_prefit. V1.1 changes numerical audit only: CPU exact causality0 + all120 equivariance<1e-5; CUDA <=1e-6 diagnostic; training remains CUDA. Data/scaler/init/seeds/budgets/loss/selection/threshold unchanged. See `docs/V5_PROTOCOL_INCIDENT.md`. Corrected v1.1 froze from commit0f8c1e2, then all3 scratch seeds ran in temp but Friday prefit CPU equiv2.6226e-6 hit stale inherited<2e-6 despite frozen<1e-5. No output/checkpoint retained and scratch restarts; no Friday/V4 fit or test. Partial log SHA0270c6... + v1.1 freeze/scaler archived. V1.2 uses own declared-gate checks; scientific protocol unchanged. Actual-init tests pass; active freeze source f88a43b, protocol SHAc25e68fc..., scaler unchanged3928af5..., test locked; all candidates restart.
57. V5 v1.2 validation complete/test sealed. Action primary scratch seed51003: selection1.0192 vs V41.0926/Friday1.2138; same-scaler state MAE.4727 vs .4987/.5373 and persistence.5658; edge AP.3499 (Friday.3575,V4.3400,persist.2989); all LM F1/AP@.5 and pair AP/top1=1 under deterministic action; factual state beats opposite7/8 scratch,6/8 others. Passive primary scratch seed51003 epoch79 composite.9318 vs V4.9446/Friday.9572; expected/oracle/diversity .4609/.4597/.0987, persistence state.5340; LM AP.1615,F1@.5=0,pair AP.0092, oracle gain.0012. V4 point state .4554 best but not composite; all aligned-passive F1@.5=0. Six checkpoint SHAs in `docs/V5_VALIDATION_RESULTS.md`; script56 independent audit PASS. No test export/inference. Scripts57 evaluator,58 freeze,59 atomic one-run wrapper implemented and validation-smoked; includes shared-scaler/persistence/edge/ATT&CK/LM/pair/action counterfactual/passive expected-oracle/scenario/intent-cutoff metrics. Final Astra review required before creating unlock freeze.
58. Astra final review2026-09-12 accepted after fixes: verify all source/artifact/scaler/runtime lineage before export; permanent fsynced attempt dir and exclusive child-evaluator ticket block concurrent/repeated/failed runs; original checkpoint secondary thresholds (not CPU-reoptimized); strict bundle membership/schema/time/target checks; CUDA deterministic inference, saved forecasts, profile/episode/horizon/lead diagnostics. Eight synthetic tests and six-model validation reproduction pass; no test content read during review. Intent cutoff verified from code/synthetic fixtures. See `docs/V5_FINAL_REVIEW.md`. Freeze/one-shot execution next (completed in item59).
59. V5 sealed evaluation succeeded exactly once2026-09-12 at12:00UTC. Reviewed sources b1c5901; freeze commit e1497ff, SHA dfecbd58f04c81f762c1f84f9336c9ddaf16932cd460495fe099d2248554dc44. Permanent consumed marker `outputs/mvp_v5/sealed_test_attempt/`; report/predictions/provenance `outputs/mvp_v5/sealed_test/`. All12 artifact hashes, six checkpoints, scaler/threshold lineage,54 finite forecasts and nine saved-prediction MAEs verified without inference. Scratch action MAE .459835 vs persistence .539809, edge AP .411418, LM F1@.5=1, factual action wins8/8. Scratch passive expected/oracle .472887/.470838 vs persistence .538841, edge AP .369933, LM AP .200029, F1@.5=0. Secondary warning threshold detects3/6 progressing episodes but falsely alerts7/10 nonprogressing; intent-cutoff F1@.5=0, secondary .4. Aligned scratch passive MAE .468434 vs action .459835, but active-feature error favors passive .661994 vs .787490 and different cohorts prevent pure action ablation. Friday transfer does not improve scratch dynamics; V4 lower passive point MAE does not override frozen scratch selection. `docs/V5_TEST_RESULTS.md`. Do not retune/rerun test; next update standalone report/presentation from saved artifacts.
60. Reporting complete from saved JSON only. `scripts/61_build_v5_judge_materials.py` verifies sealed report/provenance then emits standalone V5 senior report and11-slide keyboard/print judge deck without importing Torch/loading checkpoints or predictions. Report SHA `919a42436b7f0ebf2e629b52e4046810e48d43a99870ca23d7e53c23e9186442`; deck `738fa5aeda761a3afcdf6de104908ba75686bab92dc8c1303e85a730f4ba70d2`. Outputs under `outputs/mvp_v5/report/`, compatibility report at `outputs/mvp_v2/report/`, and byte-identical Downloads copies. HTML parser found no external assets; Firefox rendered title report/deck and critical warning slide. Materials foreground passive0/6@.5 and3/6 versus7/10 low-threshold failure, deterministic action caveat, modest edge AP, tiny intent probe, and no enterprise/calibration/causal-policy claim.
...
## Current V6 prospective checkpoint (2026-09-12)
