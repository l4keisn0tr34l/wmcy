...
33. First 358,115-param graph RSSM has shared normalization/encoding/recurrent node+edge states/decoders and exact host equivariance. V2 test: state MAE 0.252, active 0.895, edge AP 0.394, robust pair top-1 0.357, but LM F1/AP only 0.476/0.738. Adopt as dynamics foundation; tune semantic heads next. See `docs/GRAPH_RSSM_RESULTS.md`.
