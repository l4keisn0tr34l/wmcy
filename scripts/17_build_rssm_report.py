...
<div class="callout good"><strong>Observability result:</strong> alternative branch specialization transfers, but the gate does not recover hidden future decisions. On the same evaluation contexts, supplying the already-chosen action raises directly comparable LM F1 0.400→1.000; within the action model, the factual action beats the opposite action on state error 10/10 times. Passive/action state MAEs use different frozen training scalers and are not a direct ratio.</div>
