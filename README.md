...
**Current status:** equal-duration V2 is complete and removes the original late-negative censoring shortcut. An independent compact RSSM now performs six-step stochastic prior rollout: test state MAE is 0.280 versus 0.354 Ridge and 0.384 persistence; future-LM F1 is 0.800 versus 0.645 Ridge. A permutation-equivariant graph RSSM reaches state MAE 0.252 and edge AP 0.394. Observable-only UNSW pretraining raises validation edge/LM AP to 0.430/0.819 and yields exactly host-stable pair top-1 9/13; diagnostic test LM F1/AP is 0.778/0.785, with a disclosed false-alert/stochasticity trade-off. See `docs/RSSM_RESULTS.md`, `docs/RSSM_ABLATIONS.md`, `docs/KL_TUNING.md`, `docs/PAIR_EQUIVARIANCE_AUDIT.md`, `docs/SHARED_PAIR_DECODER.md`, `docs/GRAPH_RSSM_RESULTS.md`, `docs/GRAPH_SEMANTIC_RESULTS.md`, `docs/PUBLIC_PRETRAINING_RESULTS.md`, `docs/MVP_STATUS.md`, and `docs/SHORTCUT_AUDIT.md`; this remains controlled-lab evidence, not enterprise generalization.
